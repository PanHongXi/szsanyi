...
<div id="container">
    ...
    <div class="list">
        <div class="list_main clearfix">
            <?php foreach($articleRes as $k=> $art) :?>
            <div class="per" <?php if(($k+1)%4 == 0){echo 'style="margin-right:0"';} ;?>>
            <a target="_blank" href="/sucai/index.php/Home/Article/article/cate_id/<?php echo ($art['cate_id']); ?>/article_id/<?php echo ($art['article_id']); ?>" class="img_link">
                <img style="display: inline;"  src="/sucai/<?php echo $art['article_pic'];?>" original="" alt="<?php echo $art['article_title'];?>" class="lazy">
            </a>
            <div class="foot">
                <p class="title">
    ...
    <div class="pager">
        共<strong class="red" style="color: red;"> <?php echo ($count); ?> </strong>个
        <!--<span><?php echo ($cateName['cate_name']); ?> </span>-->
        <!--<?php echo ($page); ?>-->

...
<div id="site_nav">
    <div class="sn_container clearfix">
        ...
        <ul style="" class="tg_tools fl" id="login_area">
            <li class="tg_tools_home no-hover">
                <i class="icon-more"></i>
                <span><a href="http://www.sucaihuo.com/">素材火首页</a></span>
            </li>

            <?php if(!isset($_SESSION['user_id']) or !isset($_SESSION['username'])): ?><!--!session['user_id']-->
                ...
                <span>
                    <a href="http://www.sucaihuo.com/Index/login/type/qq.html">
                        <img alt="Connect_logo_6.png" src="/sucai/Public/HOME/Images/Connect_logo_6.png"
                ...
                <?php else: ?>
                <!--/sucai/index.php/Home/Account/register-->
                <!--/sucai/index.php/Home/Lst/register-->
                <li class="no-hover  haslogin">
                <span>
                    <a href="http://www.sucaihuo.com/Member/info.html">
                        <font class="sn_login username" id="head_username"><?php echo ($_SESSION['username']); ?></font>
...
<div id="nav" class="nav">
    <div class="nav_main clearfix">
        ...
        <?php if(is_array($cateRes)): $i = 0; $__LIST__ = $cateRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="/sucai/index.php/Home/<?php if( $vo['cate_type'] == 0): ?>Lst<?php elseif($vo['cate_type'] == 1): ?>
            Page
            <?php else: ?>
            Topic<?php endif; ?>/index/cate_id/<?php echo ($vo['cate_id']); ?>" class="menu <?php if($current == $vo['cate_id']): ?>current<?php endif; ?>"><?php echo ($vo['cate_name']); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>

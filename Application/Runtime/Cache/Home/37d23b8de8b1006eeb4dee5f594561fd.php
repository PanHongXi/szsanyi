...
<head>
    ...
    <style type="text/css">
        .yanshi {
            background: url(http://127.0.0.1/sucai/Public/Home/images/yanshi.jpg) no-repeat;
        }
        .xiazai{
            background: url(http://127.0.0.1/sucai/Public/Home/images/xiazai.jpg) no-repeat;
        }
    </style>
...
<div class="breadcrumbs">
    ...
    <span>&gt;</span><?php echo ($articleRes['article_title']); ?>
</div>
    ...
    <div class="sidebar">
        <div class="sidebar_per">
            <dl>
                <dt>
                    ...
                    <strong>最新文章 <span class="name-en">/New</span></strong>
                </dt>

                <?php if(is_array($newArticle)): $i = 0; $__LIST__ = $newArticle;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newArticle): $mod = ($i % 2 );++$i;?><dd class="sidebar_articles">
                        <span><?php echo (date('m-d',$newArticle['article_time'])); ?></span>
                        <a target="_blank" href="/sucai/index.php/Home/Article/article/article_id/<?php echo ($newArticle['article_id']); ?>/cate_id/<?php echo ($newArticle['cate_id']); ?>"><?php echo ($newArticle['article_title']); ?></a>
        ...
        <div class="sidebar_per">
            <dl>
                ...
                <dd class="sidebar_tags">
                    <?php if(is_array($tagsRes)): $i = 0; $__LIST__ = $tagsRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tagsRes): $mod = ($i % 2 );++$i;?><a target="_blank" href="/sucai/index.php/Home/Article/tagesArticle/tags/<?php echo ($tagsRes); ?>"><?php echo ($tagsRes); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="sidebar_per">
            <dl>
                <dt>
                    <a href="http://www.sucaihuo.com/topic/" class="more">更多&nbsp;<span class="more-sign">&gt;</span></a>
                    <strong>相关文章<span class="name-en">/Relative</span></strong>
                </dt>
                <?php if(is_array($Relevant)): $i = 0; $__LIST__ = $Relevant;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$Relevant): $mod = ($i % 2 );++$i;?><dd class="sidebar_articles">
                        ...
                        <a target="_blank" href="/sucai/index.php/Home/Article/Article/article_id/<?php echo ($Relevant['article_id']); ?>/cate_id/<?php echo ($Relevant['article_id']); ?>"><?php echo ($Relevant['article_title']); ?></a>
                    </dd><?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="sidebar_per">
            <dl>
                <dt>
                    <a href="http://www.sucaihuo.com/topic/" class="more">更多&nbsp;<span class="more-sign">&gt;</span></a>
                    <strong>推荐文章<span class="name-en">/Recommend</span></strong>
                </dt>
                <?php if(is_array($recommend)): $i = 0; $__LIST__ = $recommend;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$recommend): $mod = ($i % 2 );++$i;?><dd class="sidebar_articles">
                        <span><?php echo (date('m-d',$recommend['article_time'])); ?></span>
                        <a target="_blank" href="/sucai/index.php/Home/Article/Article/article_id/<?php echo ($Relevant['article_id']); ?>/cate_id/<?php echo ($recommend['article_id']); ?>"><?php echo ($recommend['article_title']); ?></a>
                    </dd><?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="detail">
        <div class="head">
            <div class="head_inner">
                <?php if($admin_info['face50'] != '' ): ?><img class="round-image" width="50" height="50" alt="头像" src="/sucai/<?php echo ($admin_info['face50']); ?>"/>
                    <?php else: ?>
                    <img class="round-image" width="50" height="50" alt="头像" src="/sucai/Public/HOME/Images/avatar.jpg "/><?php endif; ?>
                <h1><?php echo ($articleRes['article_title']); ?></h1>
                <p class="info">
                    <span class="fr">来源：
                    ...
                    <span style="color: red"><?php echo ($admin_info['nickname']); ?></span>
                    <span class="addtime"><?php echo (date("Y-m-d H:i",$articleRes['article_time'])); ?></span>
                    <span>浏览(<span><?php echo ($articleRes['click']); ?></span>)</span>
            ...
            <script type="text/javascript">
                function getCollect2(obj) {
                    var artid =<?php echo ($articleRes['article_id']); ?>;
                    var obj = obj;
                    $.ajax({
                        type:"GET",
                        dataType:"json",
                        url:"/sucai/index.php/Home/Ajax/getCollect",
                        data:{mtype:1,id:artid},
        ...
        <div class="content"><?php echo htmlspecialchars_decode($articleRes['article_desc'])?></div>

        <div class="buttons">
           <?php if($articleRes['jieya'] == 1): ?><span class="btnbox" style="float: left">
             <a class="bigbtn demo yanshi" id="btn_demo" href="<?php echo ($articleRes['demosrc']); ?>" target="_blank" rel="nofollow">查看演示</a>
              <span class="dlnum">下载资源：<strong class="orange"> <?php if($articleRes['download'] == 0): ?>0<?php else: echo ($articleRes['download']); endif; ?></strong>次</span>
                </span>
               <span class="btnbox">
                <a class="bigbtn download notlogin xiazai" onclick="downloadzip('<?php echo ($articleRes["article_id"]); ?>','1')">下载资源</a>
                <span class="dlcount">下载积分： <strong class="orange"><?php echo ($articleRes['points']); ?></strong>积分</span>
             </span>
           ...
           <?php else: ?>
            ...
            <!--<div class="qrcode_box" id="qrcode_box" style="left: 401.983px; top: 932.333px; display: none;">-->
                <!--<p>手机扫码访问：</p>-->
                <!--<img src="http://www.sucaihuo.com/Box/qrcode?url=http://www.sucaihuo.com/jquery/31/3174/demo/">-->
            <!--</div>-->

        </div>
        <script type="text/javascript">
            function downloadzip(article_id,type){
                $.ajax({
                    type:'post',
                    dataType:'json',
                    url:"/sucai/index.php/Home/Article/checkdown",
                    data:{article_id:article_id,type:type},
                    success:function(data){
                        if(data==1){
//                            alert('积分不足，请充值！');
                            showSuccessTip('积分不足，请充值！');
                            return false;
                        }else if(data== -1){
//                            alert('请先登录！');
                            showSuccessTip('请先登录！');
                            ...
                            form.attr('action',"/sucai/index.php/Home/Article/downloadZip");
                            var input1=$('<input>');
                            input1.attr('type','hidden');
                            input1.attr('name','article_id');
                            input1.attr('value',article_id);
                            var input2=$('<input>');
        ...
        <div class="detail_foot clearfix">
            ...
            <div class="tagged_with">
                ...
                <?php if(is_array($tages)): $i = 0; $__LIST__ = $tages;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tages): $mod = ($i % 2 );++$i;?><a target="_blank" class="button3 white" href="/sucai/index.php/Home/Article/tagesArticle/tags/<?php echo ($tages); ?>"><?php echo ($tages); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>

            </div>
            <div class="page_nav clearfix">
                <div class="next_page" title="下一篇">
                    <a href="/sucai/index.php/Home/Article/article/article_id/<?php echo ($next['article_id']); ?>"> <?php echo ($next['article_title']); ?></a>
                </div>
                <div class="pre_page" title="上一篇">
                    <a href="/sucai/index.php/Home/Article/article/article_id/<?php echo ($prev['article_id']); ?>"><?php echo ($prev['article_title']); ?></a>
                </div>
                ...
                <textarea id="textareaComment" class="textarea_comment" name="content" autocomplete="off"
                        ...
                        <div class="btn_p clearfix">
                            ...
                            <button class="btn_subGrey btn" type="button"
                                    onclick="subcomment('<?php echo ($articleRes["article_id"]); ?>', '1', 0)">提 交
                            </button>
                                    ...
                                    <div class="comment_conBox">
                                        ...
                                        <div id='reply_<?php echo ($comment["comment_id"]); ?>' class='reply_area'>
                                            ...
                                            <div class="btn_p clearfix">
                                                ...
                                                <button class="btn_subGrey btn" onclick="subcomment('<?php echo ($articleRes["article_id"]); ?>', '1', '<?php echo ($comment["comment_id"]); ?>', 0)" type="button">提交
                                                </button>
                                            ...
                                            <?php if($commentSecond): if(is_array($commentSecond)): $i = 0; $__LIST__ = $commentSecond;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$commentSecond): $mod = ($i % 2 );++$i; if($commentSecond['pid'] == $comment['comment_id']): ?><blockquote class="comment_blockquote">
                                                            ...
                                                            <div id="reply_<?php echo ($commentSecond["comment_id"]); ?>" class="reply_area">
                                                                ...
                                                                <div class="btn_p clearfix">
                                                                    ...
                                                                    <button class="btn_subGrey btn" type="button"  onclick="subcomment('<?php echo ($articleRes["article_id"]); ?>', '1', '<?php echo ($comment["comment_id"]); ?>', '<?php echo ($commentSecond["comment_id"]); ?>')">提交 </button>
                                                        ...
                                                        <?php if($commentRes): if(is_array($commentRes)): $i = 0; $__LIST__ = $commentRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$commentRes): $mod = ($i % 2 );++$i; if($commentRes['touid'] == $commentSecond['comment_id']): ?><blockquote class="comment_blockquote">
                                                                        ...
                                                                        <div class="reply_area" id="reply_<?php echo ($commentRes["comment_id"]); ?>">
                                                                            ...
                                                                            <div class="btn_p clearfix">
                                                                                ...
                                                                                <button onclick="subcomment('<?php echo ($articleRes["article_id"]); ?>', '1', '<?php echo ($commentRes["pid"]); ?>', '<?php echo ($commentRes["comment_id"]); ?>')" type="button" class="btn_subGrey btn">提交</button>

...
<div class="wenda clearfix w">
    <div class="wenda-main">
        <ul class="wenda-tab clearfix">
            <li  <?php if(strstr($scateid,',')):?>class='tabactive'<?php endif;?> ><a href="/sucai/index.php/Home/Topic/index/cate_id/<?php echo ($current); ?>">全部话题</a></li>
            <?php if(is_array($scateres)): $i = 0; $__LIST__ = $scateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$scateres): $mod = ($i % 2 );++$i;?><li <?php if($scateres['cate_id'] == $scateid): ?>class="tabactive"<?php endif; ?> >
                <a href="/sucai/index.php/Home/Topic/index/cate_id/<?php echo ($current); ?>/scateid/<?php echo ($scateres['cate_id']); ?>/state/<?php echo ($state); ?>"><?php echo ($scateres['cate_name']); ?></a>
                </li><?php endforeach; endif; else: echo "" ;endif; ?>

        </ul>

        <div class="newpost clearfix">
            <a class="quealltab <?php if($state == "" ): ?>onactive<?php endif; ?> " href="/sucai/index.php/Home/Topic/index/cate_id/<?php echo ($current); ?>/<?php if(!strstr($scateid,',')):?>scateid/<?php echo ($scateid); endif;?>">最新</a>
            <a class="quealltab <?php if($state == "hot" ): ?>onactive<?php endif; ?> " href="/sucai/index.php/Home/Topic/index/cate_id/<?php echo ($current); ?>/<?php if(!strstr($scateid,',')):?>scateid/<?php echo ($scateid); endif;?>/state/hot">热门</a>
            <a class="quealltab <?php if($state == "wait" ): ?>onactive<?php endif; ?> " href="/sucai/index.php/Home/Topic/index/cate_id/<?php echo ($current); ?>/<?php if(!strstr($scateid,',')):?>scateid/<?php echo ($scateid); endif;?>/state/wait">等待回复</a>
        </div>
        <!--左侧列表内容-->
            ...
            <?php foreach ($topicRes as $k=>$v ) : ?>
                ...
                <div class="headslider">
                    <a title="<?php echo $v['userinfo']['nickname'] ;?>" target="_blank" class="wenda-head" href="">
                        <?php if($v['userinfo']['face50'] != ''): ?><img width="40" height="40" src="/sucai<?php echo $v['userinfo']['face50'] ;?>" alt='<?php echo $v["userinfo"]["nickname"] ;?>'/>
                        <?php else: ?>
                ...
                <div class="wendaslider">
                    ...
                    <h2 class="wendaquetitle">
                        ...
                        <div class="wendatitlecon">
                            <a class="wendatitle"  href="/sucai/index.php/Home/Topicart/topicArt/topic_id/<?php echo $v['topic_id'] ;?>/cate_id/<?php echo $v['cate_id'] ;?>"><?php echo $v['topic_title'] ;?></a>
                        </div>
                    </h2>
                    ...
                    <div class="replycont clearfix">
                        ...
                        <div class="l replydes">
                            ...
                            <?php if($v['userinfo']['face50'] != ''): ?><img width="20" height="20" src="/sucai<?php echo $v['commenter']['face50'] ;?>" alt='头像'>
                                <?php else: ?>
 ...
 if($v['keywords']): $arr =array_filter(explode(',',$v['keywords'])); foreach($arr as $k1=>$v1 ) : ?>
                            ...
                            <a target="_blank" class="list-tag" href="http://www.sucaihuo.com/topic/tag-Html/CSS.html"><?php  echo $v1 ;?></a>
    ...
    <div class="wenda-slider">
        ...
        <div class="newques-container">
            <a  id="js-newques" class="newques-btn" href="/sucai/index.php/Home/Topic/addTopic"><i class="icon-addques"></i>发新话题</a>
        </div>

        <div class="panel wenda-form clearfix">
            <div class="panel-body clearfix">

                <?php if(is_array($tagsRes)): $i = 0; $__LIST__ = $tagsRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tagsRes): $mod = ($i % 2 );++$i;?><a class="hot-label"   href="http://www.sucaihuo.com/topic/tag-<?php echo ($tagsRes); ?>" style="margin:0 6px 10px 0"><?php echo ($tagsRes); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div>
        <div class="panel hot">
            ...
            <div class="panel-body clearfix">
                <ul class="weekly-hot">
                   <?php foreach($topicWeek as $k => $v) : ?>
                    <li <?php if($k == 0){echo 'class="padtop"';} ;?> ><em class="hoticon hot<?php echo $k+1;?>">热</em><a class="hottalk" target="" href="/sucai/index.php/Home/Topicart/topicart/topic_id/<?php echo $v['topic_id']?>/cate_id/<?php echo $v['cate_id']?>"><?php echo mb_substr($v['topic_title'],0,10,'utf-8'); ;?></a><i class="rankingnum"><?php echo $v['comment']?><br>回答</i></li>
                  <?php endforeach ;?>
                </ul>
            </div>
        </div>

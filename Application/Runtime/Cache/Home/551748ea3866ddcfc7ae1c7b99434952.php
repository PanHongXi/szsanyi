    ...
    <div class="member_main">
        <div class="perInfo">
            ...
            <div class="firstTabBox lineSpace">
                <a class="tab " href="/sucai/index.php/Home/Userinfo/user_info">个人资料</a>
                <span class="line">|</span>
                <a class="tab currentTab" href="/sucai/index.php/Home/Userinfo/user_face">头像设置</a>
                <span class="line">|</span>
        ...
        <div class="setting-right-wrap wrap-boxes settings" id="avatar_main">
            ...
            <div id="show_photo" style="border:1px solid #f7f7f7;margin:20px 0 0">
                ...
                <?php if($face != '' ): ?><img id="faceimg" src="/sucai/<?php echo ($face); ?>" alt="头像">
                    <?php else: ?>
                    <img id="faceimg" src="/sucai/Public/HOME/Images/avatar.jpg " alt="头像"><?php endif; ?>

                <!--<img id="faceimg" src=" <?php if($face != '' ): ?>/sucai/<?php echo ($face); ?> <?php else: ?> /sucai/Public/HOME/Images/avatar.jpg<?php endif; ?> " alt="头像">-->
            </div>
...
<!--<script type="text/javascript" src="/sucai/Public/HOME/style/ajaxfileupload.js"></script>-->
...
<!--<script type="text/javascript" src="/sucai/Public/HOME/style/iframeTools.js"></script>-->
...
<script type="text/javascript">
    ...
    $('#face').uploadify({
        ...
        onUploadSuccess: function (File, data, response) {
            eval('var data=' + data);
            if (data.status) {
                $.post('/sucai/index.php/Home/Userinfo/setFace', {
                    max: data.path.max,
                    mid: data.path.mid,

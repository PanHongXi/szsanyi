    ...
    <div class="member_main">
        <div class="perInfo">
            ...
            <div class="firstTabBox lineSpace">
                ...
                <span class="line">|</span>
                <a class="tab currentTab" href="/sucai/index.php/Home/Userinfo/checkEmail">邮箱验证</a>
                <span class="line">|</span>
        ...
        <div class="setting-right-wrap wrap-boxes settings">
            <div id="setting-profile" class="setting-wrap setting-profile">
                ...
                <div class="setting-verify">
                    ...
                    <?php if($userinfo['checkemail'] == 1): ?><div class="verify-status verified-status">
                            <div>邮箱已验证</div>
                            <i class="verify-on-icon"></i>
                            <!--<img src="/sucai/Public/HOME/Images/validmail-icon.png" alt=""/>-->
                        </div>
                        <?php else: ?>
                        <div class="verify-status verified-status">
                            <span class="verify-un">邮箱未验证</span>
                        </div>
                        <button id="email_check" class="btn-green btn">发送验证邮件</button><?php endif; ?>
                </div>
            </div>
        </div>
    </div>

...
<div class="wenda clearfix w">
    <div class="wenda-main">
        ...
        <div class="tag_head">
            <a class="rechose" href="http://www.sucaihuo.com/topic/">
                <i class="icon-returnback"></i>
                重置筛选条件
            </a>
            <h1>标签：<strong><?php echo ($tag); ?></strong></h1>
        </div>
        <!--左侧列表内容-->
 ...
 if($v['keywords']): $arr =array_filter(explode(',',$v['keywords'])); foreach($arr as $k1=>$v1 ) : ?>
                                    ...
                                    <a target="_blank" class="list-tag" href="/sucai/index.php/Home/Topic/tagsArr/cate_id/<?php echo $_GET['cate_id'];?>/tags/<?php echo ($v1); ?>"><?php  echo $v1 ;?></a>
    ...
    <div class="wenda-slider">
        ...
        <div class="newques-container">
            <a  id="js-newques" class="newques-btn" href="/sucai/index.php/Home/Topic/addTopic/cate_id/<?php echo ($current); ?>"><i class="icon-addques"></i>发新话题</a>
        </div>

        <div class="panel wenda-form clearfix">
            <div class="panel-body clearfix">

                <?php if(is_array($tagsRes)): $i = 0; $__LIST__ = $tagsRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tagsRes): $mod = ($i % 2 );++$i;?><a class="hot-label"   href="/sucai/index.php/Home/Topic/tagsArr/cate_id/<?php echo $_GET['cate_id'];?>/tags/<?php echo ($tagsRes); ?>" style="margin:0 6px 10px 0"><?php echo ($tagsRes); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div>
        <div class="panel hot">

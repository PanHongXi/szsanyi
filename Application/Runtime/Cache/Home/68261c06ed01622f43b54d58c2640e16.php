    ...
    <form onsubmit="return false">
        <div class="pop-content accountPage">
            <div class="form_item">
                ...
                <input type="text" tabindex="1" value="" name="username" data-type="username" data-minlength="5"
                       class="form_input" id="username" onfocus="focusInputLoginArea($(this))"
            ...
            <div class="form_item">
                ...
                <input type="text" tabindex="2" value="" data-type="email" name="email" class="form_input" id="email"
            ...
            <div class="form_item">
                ...
                <input type="password" tabindex="3" name="pwd" id="pwd" data-minlength="6" data-maxlength="20"
                       class="form_input" onfocus="focusInputLoginArea($(this))" onblur="blurInputLoginArea($(this))"
                       autocomplete="off"/>
                <span class="error">不能为空</span>
            ...
            <div class="form_item">
                ...
                <input type="password" tabindex="4" name="pwd2" data-equal="#pwd" data-equal-error="两次输入的密码不一致"
                       class="form_input" id="pwd2" onfocus="focusInputLoginArea($(this))"
                       onblur="blurInputLoginArea($(this))" autocomplete="off"/>
                <span class="error">不能为空</span>
                <i class="icon-loginright"></i>
            </div>
            <div class="form_item" style="margin:30px  0 0">
                <input type="submit" tabindex="7" value="注&nbsp;&nbsp;册" class="btn_reg btn common_bgcolor" id="btn_reg"
                       onclick="subReg()"/>
            </div>

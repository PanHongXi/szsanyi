    ...
    <div class="member_main">
        <div class="perInfo">
            ...
            <div class="firstTabBox lineSpace">
                ...
                <span class="line">|</span>
                <a class="tab currentTab" href="/sucai/index.php/Home/Userinfo/user_pwd">修改密码</a>

            </div>
        </div>
        <div class="setting-right-wrap wrap-boxes settings">
            <div class="pwd-reset-wrap setting-resetpwd">
                <form novalidate="novalidate" id="form" name="form" method="post" action="/sucai/index.php/Home/Userinfo/user_pwd">
                    <div class="wlfg-wrap">
...
<script src="/sucai/Public/HOME/style/validate.js"></script>
...
//
            ...
            rules: {
                pwdOld: {
                    required: true,
                    remote: {
                        url: "/sucai/index.php/Home/Userinfo/oldPwd",
                        type: 'post',
                        data: {
                            pwdOld: function() {
                                return $('#pwdOld').val();

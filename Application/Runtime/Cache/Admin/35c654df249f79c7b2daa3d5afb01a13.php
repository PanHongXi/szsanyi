...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">系统列表</h2>
            <a href="/sz/index.php/Admin/Contact/add" class="fr top_rt_btn add_icon">添加系统配置</a>
        </div>
        <table class="table">
            <tr>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="center">
                        <a href="/sz/index.php/Admin/Contact/edit/id/<?php echo ($list['id']); ?>" title="编辑"
                           class="link_icon">&#101;</a>
                        <a href="/sz/index.php/Admin/Contact/del/id/<?php echo ($list['id']); ?>"

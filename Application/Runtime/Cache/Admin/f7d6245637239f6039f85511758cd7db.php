...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">添加话题</h2>
            <a class="fr top_rt_btn" href="/sucai/index.php/Admin/Article/article_list">返回话题列表</a>
        </div>
            ...
            <section>
                <ul class="ulColumn2">
                    <li>
                        ...
                        <input type="text" name="topic_title" class="textbox textbox_295" placeholder="话题标题..."/>
                    </li>
                    <!--<li>-->
                        <!--<span class="item_name" style="width:120px;">话题作者：</span>-->
                        <!--<input  type="text" name="username" class="textbox textbox_295"  placeholder="话题作者..."/>-->
                    <!--</li>-->
                    <li>
                        <span class="item_name" style="width:120px;">话题关键字：</span>
                        <input type="text" name="keywords" class="textbox textbox_295"  placeholder="话题关键字.多个用半角’,‘分割"/>
                    </li>
                    <li>

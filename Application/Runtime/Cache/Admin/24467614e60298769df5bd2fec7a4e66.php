...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">添加属性</h2>
            <a class="fr top_rt_btn" href="/sucai/index.php/Admin/Attrs/attrValue">返回属性</a>
        </div>
        <form method="post" action="">
            <input type="hidden" name="attr_id" value="<?php echo ($attrs['attr_id']); ?>"/>
            <section>
                <ul class="ulColumn2">
                    <li>
                        <span class="item_name" style="width:120px;">所属类型：</span>
                        <select name="type_id" class="textbox textbox_295">
                            <?php if(is_array($typeattr)): $i = 0; $__LIST__ = $typeattr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$typeattr): $mod = ($i % 2 );++$i;?><option value="<?php echo ($typeattr['type_id']); ?>" <?php if($typeattr['type_id'] == $attrs['typeattr_id']): ?>selected="selected"<?php endif; ?>><?php echo ($typeattr['type_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">属性名称：</span>
                        <input type="text" name="attr_name" value="<?php echo ($attrs['attr_name']); ?>" class="textbox textbox_295" placeholder="属性名称..."/>
                        <span class="errorTips">属性名称不能为空...</span>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">属性值：</span>
                        <textarea required="required" name="attr_value" class="textbox textbox_295" style="width: 500px;height: 200px;" placeholder="栏目描述"><?php echo ($attrs['attr_value']); ?></textarea>
                        <span class="errorTips">多个属性值请用英文的逗号“,”分隔...</span>
                    </li>
                </ul>
                <li>

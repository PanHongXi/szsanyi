...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">添加类型</h2>
            <a class="fr top_rt_btn" href="/sz/index.php/Admin/Articlestype/lstType">返回类型</a>
        </div>
        <form method="post" action="">
            <input value="<?php echo ($info['type_id']); ?>" type="hidden" name="type_id"/>
            <section>
                <ul class="ulColumn2">
                    <li>
                        <span class="item_name" style="width:120px;">类型名称：</span>
                        <input type="text" name="type_name" value="<?php echo ($info['type_name']); ?>" class="textbox textbox_295" placeholder="类型名称..."/>
                    </li>
                </ul>
                <li>

...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            ...
            <a href="/sz/index.php/Admin/Brief/add" class="fr top_rt_btn add_icon">添加简介</a>
        </div>
        ...
        <form action="/sz/index.php/Admin/Brief/catesort" method="post">
            <table class="table">
                <tr>
                ...
                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="center">
                            <?php if($vo['brief_pic'] != ''): ?><img src="/sz<?php echo ($vo['brief_pic']); ?>" width="50" height="50"/>
                                <?php else: ?>
                                暂无图片<?php endif; ?>
                        </td>
                        <td class="center">
                        ...
                        <td class="center">
                            <a href="/sz/index.php/Admin/Brief/edit/brief_id/<?php echo ($vo['brief_id']); ?>" title="编辑"
                               class="link_icon">&#101;</a>
                            <a href="/sz/index.php/Admin/Brief/del/brief_id/<?php echo ($vo['brief_id']); ?>"

    ...
    <ul>
        ...
        <li>
            <dl>
                ...
                <dd><a href="/sz/index.php/Admin/Points/lst">三一精工简介</a></dd>
...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            ...
            <a href="/sz/index.php/Admin/Points/add" class="fr top_rt_btn add_icon">添加简介</a>
        </div>
        ...
        <form action="/sz/index.php/Admin/Points/catesort" method="post">
            <table class="table">
                <tr>
                    <th style="width: 50px">系统ID</th>
                    <th>系统标题</th>
                    <th>系统作者</th>
                    <th>系统类型</th>
                    <th>缩略图</th>
                ...
                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="center">
                            <?php if($vo['article_pic'] != ''): ?><img src="/sz<?php echo ($vo['article_pic']); ?>" width="50" height="50"/>
                                <?php else: ?>
                                暂无图片<?php endif; ?>
                        </td>
                        <td class="center">
                        ...
                        <td class="center">
                            ...
                            <a href="/sz/index.php/Admin/Points/article_edit/article_id/<?php echo ($vo['article_id']); ?>" title="编辑"
                               class="link_icon">&#101;</a>
                            <a href="/sz/index.php/Admin/Points/article_del/article_id/<?php echo ($vo['article_id']); ?>"

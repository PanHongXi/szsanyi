...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">类型列表</h2>
            <a href="/sz/index.php/Admin/Attrtype/addType" class="fr top_rt_btn add_icon">添加类型</a>
        </div>
        <table class="table">
            <tr>
                <th>类型Id</th>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="center">
                        <a href="/sz/index.php/Admin/Attrtype/editType/type_id/<?php echo ($list['type_id']); ?>" title="编辑" class="link_icon">&#101;</a>
                        <a href="/sz/index.php/Admin/Attrtype/delType/type_id/<?php echo ($list['type_id']); ?>" onclick="return confirm('您确定要删除吗？');" title="删除" class="link_icon  twitter" id="demo3">&#100;</a>
                    </td>

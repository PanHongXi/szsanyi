    ...
    <ul>
        ...
        <li>
            <dl>
                ...
                <dd><a href="/sz/index.php/Admin/Brief/lst">三一精工简介</a></dd>
...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        ...
        <form method="post" action="" enctype="multipart/form-data">
            <input value="<?php echo ($briefInfo['brief_id']); ?>" name="brief_id" type="hidden"/>
            <section>
                <ul class="ulColumn2">
                    <li>
                        <span class="item_name" style="width:120px;">文章标题：</span>
                        <input type="text" value="<?php echo ($briefInfo['brief_title']); ?>" name="brief_title" class="textbox textbox_295"  placeholder="文章标题..."/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">文章作者：</span>
                        <input type="text" name="brief_author" class="textbox textbox_295" value="<?php echo ($briefInfo['brief_author']); ?>" placeholder="文章作者..."/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">文章关键字：</span>
                        <input type="text" name="brief_keys" value="<?php echo ($briefInfo['brief_keys']); ?>" class="textbox textbox_295" placeholder="文章关键字.多个用半角’,‘分割"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">文章描述：</span>
                        <textarea name="brief_desc" class="textbox textbox_295"
                                  style="width: 500px;height: 200px;" placeholder="文章描述"><?php echo ($briefInfo['brief_desc']); ?></textarea>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">文章推荐：</span>
                        <label class="single_selection"><input type="radio" value="0" name="brief_reco" <?php if($briefInfo['brief_reco'] == 0): ?>checked="checked"<?php endif; ?>/>否</label>
                        <label class="single_selection"><input type="radio" value="1" name="brief_reco" <?php if($briefInfo['brief_reco'] == 1): ?>checked="checked"<?php endif; ?>/>是</label>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">内容类型：</span>
                        <label class="single_selection"><input type="radio" value="1" name="type" <?php if($briefInfo['type'] == 1): ?>checked="checked"<?php endif; ?>/>简介</label>
                        <label class="single_selection"><input type="radio" value="2" name="type" <?php if($briefInfo['type'] == 2): ?>checked="checked"<?php endif; ?>/>资质荣誉</label>
                    </li>
                    <li>
                        ...
                        <label >
                            <?php if($briefInfo['brief_pic'] != ''): ?><img width="60" height="60" src="/sz/<?php echo ($briefInfo['brief_pic']); ?>"/>
                                <?php else: ?>
                                暂无缩列图<?php endif; ?>
                        </label>
                    </li>
                    <li>
                        ...
                        <div id="btns" style="margin-left:120px;margin-top:8px;">
                            <textarea id="content" name="brief_content"><?php echo ($briefInfo['brief_content']); ?></textarea>
                        </div>
                    </li>
                    <li>

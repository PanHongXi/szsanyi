...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        ...
        <form method="post" action="">
            <input value="<?php echo ($info['articles_id']); ?>" type="hidden" name="articles_id"/>
            <section>
                <ul class="ulColumn2">
                    <li>
                        <span class="item_name" style="width:120px;">类型名称：</span>
                        <input type="text" name="articles_name" value="<?php echo ($info['articles_name']); ?>" class="textbox textbox_295" placeholder="类型名称..."/>
                    </li>
                </ul>
                <li>

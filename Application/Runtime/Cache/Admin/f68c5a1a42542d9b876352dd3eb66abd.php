...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">文章列表</h2>
            <a href="/sz/index.php/Admin/Article/article_add" class="fr top_rt_btn add_icon">添加文章</a>
        </div>
        ...
        <form action="/sz/index.php/Admin/Article/catesort" method="post">
            <table class="table">
                <tr>
                ...
                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="center">
                            ...
                            <a href="/sz/index.php/Admin/Article/article_edit/article_id/<?php echo ($vo['article_id']); ?>" title="编辑"
                               class="link_icon">&#101;</a>
                            <a href="/sz/index.php/Admin/Article/article_del/article_id/<?php echo ($vo['article_id']); ?>"

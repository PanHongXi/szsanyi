...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">添加属性</h2>
            <a class="fr top_rt_btn" href="/sz/index.php/Admin/Attrs/attrValue">返回属性</a>
        </div>
            ...
            <section>
                <ul class="ulColumn2">
                    <li>
                        ...
                        <select name="typeattr_id" class="textbox textbox_295">
                    ...
                    <li>
                        ...
                        <input type="text" name="attr_name" class="textbox textbox_295" placeholder="属性名称..."/>
                        <span class="errorTips">属性名称不能为空...</span>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">属性值：</span>
                        <textarea required="required" name="attr_value" class="textbox textbox_295" style="width: 500px;height: 200px;" placeholder="栏目描述"></textarea>

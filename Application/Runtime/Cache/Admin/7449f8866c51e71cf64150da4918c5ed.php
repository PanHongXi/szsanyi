...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">话题列表</h2>
            <a href="/szsanyi/index.php/Admin/Topic/topicAdd" class="fr top_rt_btn add_icon">添加话题</a>
        </div>
        ...
        <form action="/szsanyi/index.php/Admin/Topic/catesort" method="post">
            <table class="table">
                <tr>
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="center">
                            ...
                            <a href="/szsanyi/index.php/Admin/Topic/topicEdit/topic_id/<?php echo ($vo['topic_id']); ?>" title="编辑"
                               class="link_icon">&#101;</a>
                            <a href="/szsanyi/index.php/Admin/Topic/topic_del/topic_id/<?php echo ($vo['topic_id']); ?>"

...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">添加话题</h2>
            <a class="fr top_rt_btn" href="/sucai/index.php/Admin/Topic/topic_lst">返回话题列表</a>
        </div>
        <form method="post" action="" enctype="multipart/form-data">
            <input type="hidden" name="topic_id" value="<?php echo ($topicView['topic_id']); ?>"/>
            <section>
                <ul class="ulColumn2">
                    <li>
                        <span class="item_name" style="width:120px;">话题标题：</span>
                        <input value="<?php echo ($topicView['topic_title']); ?>" type="text" name="topic_title" class="textbox textbox_295" placeholder="话题标题..."/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">话题作者：</span>
                        <input value="<?php echo ($topicView['username']); ?>" disabled="disabled"  type="text" name="username" class="textbox textbox_295"  placeholder="话题作者..."/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">话题关键字：</span>
                        <input value="<?php echo ($topicView['keywords']); ?>" type="text" name="keywords" class="textbox textbox_295"  placeholder="话题关键字.多个用半角’,‘分割"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">话题类型：</span>
                        <select class="select" name="cate_id">

                            <?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($vo['cate_id'] == $topicView['cate_id']): ?>style="color:red;"<?php endif; ?>
                                <?php if($vo['cate_id'] == $topicView['cate_id']): ?>selected="selected"<?php endif; ?> value="<?php echo ($vo['cate_id']); ?>">
                    ...
                    <li>
                        ...
                        <label >
                            <?php if($topicView['attachment'] != ''): ?><img width="60" height="60" src="<?php echo ($topicView['attachment']); ?>"/>
                                <?php else: ?>
                                暂无附件<?php endif; ?>
                        </label>
                    </li>
                    <li>
                        ...
                        <div id="btns" style="margin-left:120px;margin-top:8px;">
                            <textarea id="content" name="content"><?php echo ($topicView['content']); ?></textarea>
                        </div>
                    </li>
                    <li>

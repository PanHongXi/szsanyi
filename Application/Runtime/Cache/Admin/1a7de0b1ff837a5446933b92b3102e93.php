...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">属性列表</h2>
            <a href="/sz/index.php/Admin/Attrs/addValue" class="fr top_rt_btn add_icon">添加属性</a>
        </div>
        <table class="table">
            <tr>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="center">
                        <a href="/sz/index.php/Admin/Attrs/editAttr/attr_id/<?php echo ($list['attr_id']); ?>" title="编辑" class="link_icon">&#101;</a>
                        <a href="/sz/index.php/Admin/Attrs/delAttr/attr_id/<?php echo ($list['attr_id']); ?>" onclick="return confirm('您确定要删除吗？');" title="删除" class="link_icon  twitter" id="demo3">&#100;</a>
                    </td>

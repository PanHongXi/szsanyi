            ...
            <section>
                <ul class="ulColumn2">
                    <li>
                        ...
                        <input type="text" name="link_title" class="textbox textbox_295"  placeholder="标题..."/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">链接：</span>
                        <input type="text" name="link_url" class="textbox textbox_295" value="" placeholder="链接..."/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">描述：</span>
                        <textarea name="link_desc" class="textbox textbox_295" style="width: 500px;height: 200px;" placeholder="描述"></textarea>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <div id="btns" style="margin-left:120px;margin-top:8px;">
                            <textarea id="content" name="link_content"></textarea>
                        </div>
                    </li>
                    <li>

...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">修改链接</h2>
            <a class="fr top_rt_btn" href="/sz/index.php/Admin/Link/linkList">返回列表</a>
        </div>
            ...
            <section>
                <ul class="ulColumn2">
                    <li>
                        ...
                        <input type="text" name="link_title" value="<?php echo ($info['link_title']); ?>" class="textbox textbox_295"  placeholder="标题..."/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">链接：</span>
                        <input type="text" name="link_url" class="textbox textbox_295" value="<?php echo ($info['link_url']); ?>" placeholder="链接..."/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">描述：</span>
                        <textarea name="link_desc" class="textbox textbox_295" style="width: 500px;height: 200px;" placeholder="描述"><?php echo ($info['link_desc']); ?></textarea>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">是否显示：</span>
                        <label class="single_selection"><input type="radio" value="0" name="link_status" <?php if($info['link_status'] == 0): ?>checked="checked"<?php endif; ?>/>否</label>
                        <label class="single_selection"><input type="radio" value="1" name="link_status" <?php if($info['link_status'] == 1): ?>checked="checked"<?php endif; ?>/>是</label>
                    </li>
                    <li>
                        ...
                        <label >
                            <?php if($info['link_pic'] != ''): ?><img width="60" height="60" src="/sz/<?php echo ($info['link_pic']); ?>"/>
                                <?php else: ?>
                                暂无缩列图<?php endif; ?>
                        </label>
                    </li>
                    <li>
                        ...
                        <div id="btns" style="margin-left:120px;margin-top:8px;">
                            <textarea id="content" name="link_content"><?php echo ($info['link_content']); ?></textarea>
                        </div>
                    </li>
                    <li>

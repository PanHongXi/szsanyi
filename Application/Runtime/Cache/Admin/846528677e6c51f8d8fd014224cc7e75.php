...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">添加栏目</h2>
            <a class="fr top_rt_btn" href="/sz/index.php/Admin/Cate/catelist">返回栏目列表</a>
        </div>
                ...
                <ul class="ulColumn2">
                    ...
                    <li>
                        ...
                        <select class="select" name="cate_parentid">
                            ...
                            <?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['cate_id']); ?>">
                                    <?php echo str_repeat("-",$vo["level"]*3);?>  <?php echo ($vo['cate_name']); ?>

            ...
            <section>
                <ul class="ulColumn2">
                    <li>
                        ...
                        <input type="text" name="people" class="textbox textbox_295" value=""/>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <input type="text" name="wechat" class="textbox textbox_295" value="" />
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">传真：</span>
                        <input type="text" name="fax" class="textbox textbox_295" value=""/>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <input name="qq" class="textbox textbox_295" value=""/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">地址公司：</span>
                        <input name="address" class="textbox textbox_295" value=""/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">工厂地址：</span>
                        <input name="faddress" class="textbox textbox_295" value=""/>
                    </li>
                    <li>

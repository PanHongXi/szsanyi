...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">广告位置</h2>
            <a href="/szsanyi/index.php/Admin/Ad/ad_position_add" class="fr top_rt_btn add_icon">添加广告位</a>
        </div>
        ...
        <form action="/szsanyi/index.php/Admin/Ad/catesort" method="post">
            <table class="table">
                <tr>
                    <th style="width: 50px">广告ID</th>
                    <th>广告位名称</th>
                    <th>高度</th>
                    <th>宽度</th>
                    <th>广告位描述</th>
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td class="center"><?php echo ($vo['position_id']); ?></td>
                        <td class="center"><?php echo ($vo['position_name']); ?></td>
                        <td class="center"><?php echo ($vo['ad_height']); ?></td>
                        <td class="center"><?php echo ($vo['ad_width']); ?></td>
                        <td><?php echo ($vo['position_desc']); ?></td>
                        <td class="center">
                            <a href="" title="预览" class="link_icon" target="_blank">&#118;</a>
                            <a href="/szsanyi/index.php/Admin/Ad/ad_position_add/id/<?php echo ($vo['position_id']); ?>" title="编辑"
                               class="link_icon">&#101;</a>
                            <a href="/szsanyi/index.php/Admin/Ad/ad_position_del/id/<?php echo ($vo['position_id']); ?>"

...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">栏目列表</h2>
            <a href="/szsanyi/index.php/Admin/Cate/cateadd" class="fr top_rt_btn add_icon">添加栏目</a>
        </div>
        <section class="mtb">
            <select class="select">
                <option>下拉菜单</option>
        ...
        <form action="/szsanyi/index.php/Admin/Cate/catesort" method="post">
        <table class="table">
            <tr>
                <th>栏目ID</th>
                <th>栏目排序</th>
            ...
            <?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td class="center">
                        <?php if($vo['cate_pic'] != ''): ?><img src="/szsanyi<?php echo ($vo['cate_pic']); ?>" width="50" height="50"/>
                            <?php else: ?>
                            暂无图片<?php endif; ?>
                    </td>
                    <td class="center">
                    ...
                    <td class="center">
                        <a href="/szsanyi/index.php/Admin/Article/article_list/cate_id/<?php echo ($vo['cate_id']); ?>" title="预览" class="link_icon" target="_blank">&#118;</a>
                        <a href="/szsanyi/index.php/Admin/Cate/cateedit/cate_id/<?php echo ($vo['cate_id']); ?>" title="编辑" class="link_icon">&#101;</a>
                        <a href="/szsanyi/index.php/Admin/Cate/cate_del/cate_id/<?php echo ($vo['cate_id']); ?>"

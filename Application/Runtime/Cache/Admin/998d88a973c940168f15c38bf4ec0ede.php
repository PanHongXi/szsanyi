...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">修改类型信息</h2>
            <a class="fr top_rt_btn" href="/sucai/index.php/Admin/Attrtype/typeList">返回类型</a>
        </div>
        <form method="post" action="">
            <input type="hidden" name="type_id" value="<?php echo ($typeattrs['type_id']); ?>"/>
            <section>
                <ul class="ulColumn2">
                    <li>
                        <span class="item_name" style="width:120px;">类型名称：</span>
                        <input type="text" value="<?php echo ($typeattrs['type_name']); ?>" name="type_name" class="textbox textbox_295" placeholder="类型名称..."/>
                    </li>
                </ul>
                <li>

...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            ...
            <a class="fr top_rt_btn" href="/sucai/index.php/Admin/Admin/adminlist">返回管理员</a>
        </div>
        <form method="post" action="">
            <input type="hidden" name="a_id" value="<?php echo ($admins['a_id']); ?>"/>
            <section>
                <ul class="ulColumn2">
                    <li>
                        <span class="item_name" style="width:120px;">管理员名称：</span>
                        <input type="text" value="<?php echo ($admins['a_name']); ?>" name="a_name" class="textbox textbox_295" placeholder="管理员名称..."/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">密码：</span>
                        <input value="" type="text" name="a_password" class="textbox" placeholder="管理员..."/>
                        <span style="color: palevioletred;margin-left: 20px"> *密码为空则不修改！</span>
                    </li>
                </ul>
                <li>
                    <span class="item_name" style="width:160px;margin-left: 20%"></span>
                    <input type="submit" class="link_btn" style="width: 120px" value="保存更新"/>
                </li>
            </section>
        </form>
    </div>

...
<aside class="lt_aside_nav content mCustomScrollbar">
    ...
    <ul>
        ...
        <li>
            <dl>
                <dt>其他</dt>
                <dd><a href="/sz/index.php/Admin/Others/sy_list">系统设置</a></dd>
...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">添加类型</h2>
            <a class="fr top_rt_btn" href="/sz/index.php/Admin/Attrtype/typeList">返回类型</a>
        </div>
            ...
            <section>
                <ul class="ulColumn2">
                    <li>
                        ...
                        <input type="text" name="type_name" class="textbox textbox_295" placeholder="类型名称..."/>
                    </li>
                </ul>
                <li>

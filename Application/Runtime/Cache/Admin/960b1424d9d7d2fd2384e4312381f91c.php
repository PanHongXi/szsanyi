...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            ...
            <a href="/szsanyi/index.php/Admin/Admin/adminadd" class="fr top_rt_btn add_icon">添加管理员</a>
        </div>
        <table class="table">
            <tr>
                <th>管理员Id</th>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                    <td class="center"><?php echo ($list['a_id']); ?></td>
                    <td><?php echo ($list['a_name']); ?></td>
                    <td class="center">
                        <a href="/szsanyi/index.php/Admin/Admin/adminedit/a_id/<?php echo ($list['a_id']); ?>" title="编辑" class="link_icon">&#101;</a>
                        <a href="/szsanyi/index.php/Admin/Admin/admindel/a_id/<?php echo ($list['a_id']); ?>" onclick="return confirm('您确定要删除吗？');" title="删除" class="link_icon  twitter" id="demo3">&#100;</a>
                    </td>

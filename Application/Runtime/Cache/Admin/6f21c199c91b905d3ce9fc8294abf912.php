            ...
            <section>
                <ul class="ulColumn2">
                    <li>
                        ...
                        <input type="text" name="articles_title" class="textbox textbox_295"  placeholder="文章标题..."/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">文章作者：</span>
                        <input type="text" name="articles_author" class="textbox textbox_295" value="三一精工" placeholder="文章作者..."/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">文章关键字：</span>
                        <input type="text" name="articles_keys" class="textbox textbox_295" placeholder="文章关键字.多个用半角’,‘分割"/>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <label class="single_selection"><input type="radio" value="0" checked="checked" name="articles_reco"/>否</label>
                        <label class="single_selection"><input type="radio" value="1" name="articles_reco"/>是</label>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">文章类型：</span>
                        <select class="select" name="type_id">
                            <option value="">选择类型</option>
                            <?php if(is_array($typeList)): $i = 0; $__LIST__ = $typeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?><option value="<?php echo ($type['type_id']); ?>"><?php echo ($type['type_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <div id="btns" style="margin-left:120px;margin-top:8px;">
                            <textarea id="content" name="articles_content"></textarea>
                        </div>
                    </li>
                    <li>

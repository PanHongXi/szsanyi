...
<section class="rt_wrap content mCustomScrollbar">
    <div class="rt_content">
        <div class="page_title">
            <h2 class="fl">系统设置</h2>
            <a class="fr top_rt_btn" href="/sz/index.php/Admin/Contact/lst">返回系统列表</a>
        </div>
            ...
            <section>
                <ul class="ulColumn2">
                    <li>
                        ...
                        <input type="text" name="people" class="textbox textbox_295" value="<?php echo ($info['people']); ?>"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">手机：</span>
                        <input type="text" name="phone" class="textbox textbox_295" value="<?php echo ($info['phone']); ?>" />
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">微信号：</span>
                        <input type="text" name="wechat" class="textbox textbox_295" value="<?php echo ($info['wechat']); ?>" />
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">传真：</span>
                        <input type="text" name="fax" class="textbox textbox_295" value="<?php echo ($info['fax']); ?>"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">邮箱：</span>
                        <input type="text" name="email" class="textbox textbox_295" value="<?php echo ($info['email']); ?>"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">销售QQ：</span>
                        <input name="qq" class="textbox textbox_295" value="<?php echo ($info['qq']); ?>"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">地址公司：</span>
                        <input name="address" class="textbox textbox_295" value="<?php echo ($info['address']); ?>"/>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">工厂地址：</span>
                        <input name="faddress" class="textbox textbox_295" value="<?php echo ($info['faddress']); ?>"/>
                    </li>
                    <li>
